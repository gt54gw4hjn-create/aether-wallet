  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        <span style={{ fontSize: '1.2rem', fontWeight: 600, color: 'rgba(255,255,255,0.75)', marginRight: '4px', verticalAlign: 'baseline' }}>
          {currencySymbol}
        </span>
        {intPart}
        <span style={{ fontSize: '1.5rem', fontWeight: 700, color: 'rgba(255,255,255,0.8)', verticalAlign: 'baseline' }}>
          .{decPart}
        </span>
      </div>
